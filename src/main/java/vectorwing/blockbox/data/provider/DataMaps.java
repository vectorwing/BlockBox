...
public class DataMaps extends DataMapProvider
{
	...
	protected void gather(HolderLookup.Provider provider) {
		builder(NeoForgeDataMaps.OXIDIZABLES)
				.replace(false)
				.add(ModBlocks.COPPER_CHAIN_LINKS.get().builtInRegistryHolder(), new Oxidizable(ModBlocks.EXPOSED_COPPER_CHAIN_LINKS.get()), false)
				.add(ModBlocks.EXPOSED_COPPER_CHAIN_LINKS.get().builtInRegistryHolder(), new Oxidizable(ModBlocks.WEATHERED_COPPER_CHAIN_LINKS.get()), false)
				.add(ModBlocks.WEATHERED_COPPER_CHAIN_LINKS.get().builtInRegistryHolder(), new Oxidizable(ModBlocks.OXIDIZED_COPPER_CHAIN_LINKS.get()), false)
		...
		builder(NeoForgeDataMaps.WAXABLES)
				.replace(false)
				.add(ModBlocks.COPPER_CHAIN_LINKS.get().builtInRegistryHolder(), new Waxable(ModBlocks.WAXED_COPPER_CHAIN_LINKS.get()), false)
				.add(ModBlocks.EXPOSED_COPPER_CHAIN_LINKS.get().builtInRegistryHolder(), new Waxable(ModBlocks.WAXED_EXPOSED_COPPER_CHAIN_LINKS.get()), false)
				.add(ModBlocks.WEATHERED_COPPER_CHAIN_LINKS.get().builtInRegistryHolder(), new Waxable(ModBlocks.WAXED_WEATHERED_COPPER_CHAIN_LINKS.get()), false)
				.add(ModBlocks.OXIDIZED_COPPER_CHAIN_LINKS.get().builtInRegistryHolder(), new Waxable(ModBlocks.WAXED_OXIDIZED_COPPER_CHAIN_LINKS.get()), false)
