...
public class ModItems
{
	...
	public static final Supplier<BlockItem> COPPER_CHAIN_LINKS = registerSimpleBlockItem("copper_chain_links", ModBlocks.COPPER_CHAIN_LINKS, Items.COPPER_BARS.unaffected());
	public static final Supplier<BlockItem> EXPOSED_COPPER_CHAIN_LINKS = registerSimpleBlockItem("exposed_copper_chain_links", ModBlocks.EXPOSED_COPPER_CHAIN_LINKS, Items.COPPER_BARS.exposed());
	public static final Supplier<BlockItem> WEATHERED_COPPER_CHAIN_LINKS = registerSimpleBlockItem("weathered_copper_chain_links", ModBlocks.WEATHERED_COPPER_CHAIN_LINKS, Items.COPPER_BARS.weathered());
	public static final Supplier<BlockItem> OXIDIZED_COPPER_CHAIN_LINKS = registerSimpleBlockItem("oxidized_copper_chain_links", ModBlocks.OXIDIZED_COPPER_CHAIN_LINKS, Items.COPPER_BARS.oxidized());
	public static final Supplier<BlockItem> WAXED_COPPER_CHAIN_LINKS = registerSimpleBlockItem("waxed_copper_chain_links", ModBlocks.WAXED_COPPER_CHAIN_LINKS, Items.COPPER_BARS.waxed());
	public static final Supplier<BlockItem> WAXED_EXPOSED_COPPER_CHAIN_LINKS = registerSimpleBlockItem("waxed_exposed_copper_chain_links", ModBlocks.WAXED_EXPOSED_COPPER_CHAIN_LINKS, Items.COPPER_BARS.waxedExposed());
	public static final Supplier<BlockItem> WAXED_WEATHERED_COPPER_CHAIN_LINKS = registerSimpleBlockItem("waxed_weathered_copper_chain_links", ModBlocks.WAXED_WEATHERED_COPPER_CHAIN_LINKS, Items.COPPER_BARS.waxedWeathered());
	public static final Supplier<BlockItem> WAXED_OXIDIZED_COPPER_CHAIN_LINKS = registerSimpleBlockItem("waxed_oxidized_copper_chain_links", ModBlocks.WAXED_OXIDIZED_COPPER_CHAIN_LINKS, Items.COPPER_BARS.waxedOxidized());
	...
	public static final Supplier<BlockItem> PALE_OAK_SEAT = registerSimpleBlockItem("pale_oak_seat", ModBlocks.PALE_OAK_SEAT);
	...
	public static final Supplier<BlockItem> PALE_OAK_PALISADE = registerSimpleBlockItem("pale_oak_palisade", ModBlocks.PALE_OAK_PALISADE, Items.PALE_OAK_BUTTON);
	public static final Supplier<BlockItem> SPIKED_PALE_OAK_PALISADE = registerSimpleBlockItem("spiked_pale_oak_palisade", ModBlocks.SPIKED_PALE_OAK_PALISADE, Items.PALE_OAK_BUTTON);
	...
	public static final Supplier<BlockItem> STRIPPED_PALE_OAK_PALISADE = registerSimpleBlockItem("stripped_pale_oak_palisade", ModBlocks.STRIPPED_PALE_OAK_PALISADE, Items.PALE_OAK_BUTTON);
	public static final Supplier<BlockItem> STRIPPED_SPIKED_PALE_OAK_PALISADE = registerSimpleBlockItem("stripped_spiked_pale_oak_palisade", ModBlocks.STRIPPED_SPIKED_PALE_OAK_PALISADE, Items.PALE_OAK_BUTTON);
