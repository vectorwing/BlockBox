...
tasks.named<ProcessResources>("processResources") {
    ...
    val props = HashMap<String, String>().apply {
        ...
        this["loader_version_range"] = "[1,)"
        this["neo_version_range"] = "[26.1,26.2)"
...
neoForge {
    ...
    runs {
        ...
        register("clientData") {
            clientData()
//            gameDirectory = file("run/")
            programArguments.addAll("--mod", property("mod.id").toString(),
                "--all", "--output", file("$rootDir/src/generated/resources").getAbsolutePath(), "--existing", file("$rootDir/src/generated/resources").getAbsolutePath())
        }
    }
